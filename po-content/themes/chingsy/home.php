...
<div class="container clearfix">
	<div class="row">
		<div class="bottommargin-sm">
				<img src="<?=BASE_URL;?>/<?=DIR_CON;?>/uploads/jam_ibadah_gpib.jpg" alt="" class="aligncenter notopmargin nobottommargin">
		</div>
		...
		<div class="col_full bottommargin-lg">
			...
			<div class="col_full nobottommargin clearfix">
				...
				<div class="col-md-6 bottommargin">
				<?php
					$post_by_categorys11 = $this->post()->getPostByCategory('5', '1', 'DESC', WEB_LANG_ID);
					foreach($post_by_categorys11 as $list_post11){
				?>
					<div class="spost clearfix">
						<div class="entry-image"><a href="<?=$this->pocore()->call->postring->permalink(rtrim(BASE_URL, '/'), $list_post11);?>"><img src="<?=BASE_URL;?>/<?=DIR_CON;?>/uploads/medium/medium_<?=$list_post11['picture'];?>" alt=""></a></div>
						<div class="entry-c">
							<div class="entry-title">
								<h4><a href="<?=$this->pocore()->call->postring->permalink(rtrim(BASE_URL, '/'), $list_post11);?>"><?=$list_post11['title'];?></a></h4>
							</div>
							<ul class="entry-meta">
								<li><i class="icon-calendar3"></i> <?=$this->pocore()->call->podatetime->tgl_indo($list_post11['date']);?></li>
								<li><a href="<?=$this->pocore()->call->postring->permalink(rtrim(BASE_URL, '/'), $list_post11);?>"><i class="icon-comments"></i> <?=$this->post()->getCountComment($list_post11['id_post']);?></a></li>
							</ul>
						</div>
					</div>
				<?php } ?>
				...
				<div class="col-md-6 bottommargin">
				<?php
					$post_by_categorys12 = $this->post()->getPostByCategory('6', '1,4', 'DESC', WEB_LANG_ID);
					foreach($post_by_categorys12 as $list_post12){
				?>
					<div class="spost clearfix">
						<div class="entry-image"><a href="<?=$this->pocore()->call->postring->permalink(rtrim(BASE_URL, '/'), $list_post12);?>"><img src="<?=BASE_URL;?>/<?=DIR_CON;?>/uploads/medium/medium_<?=$list_post12['picture'];?>" alt=""></a></div>
						<div class="entry-c">
							<div class="entry-title">
								<h4><a href="<?=$this->pocore()->call->postring->permalink(rtrim(BASE_URL, '/'), $list_post11);?>"><?=$list_post12['title'];?></a></h4>
							</div>
							<ul class="entry-meta">
								<li><i class="icon-calendar3"></i> <?=$this->pocore()->call->podatetime->tgl_indo($list_post11['date']);?></li>
								<li><a href="<?=$this->pocore()->call->postring->permalink(rtrim(BASE_URL, '/'), $list_post12);?>"><i class="icon-comments"></i> <?=$this->post()->getCountComment($list_post12['id_post']);?></a></li>
							</ul>
						</div>
					</div>
				<?php } ?>
