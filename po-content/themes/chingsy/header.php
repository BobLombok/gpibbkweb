...
<header id="header" class="sticky-style-2">
	<div class="container clearfix">
		<div id="logo">
			<a href="<?=BASE_URL;?>" class="standard-logo" data-dark-logo="<?=BASE_URL.'/'.DIR_INC;?>/images/GPIB_Immanuel_Bung_Karno_Mataram.png"><img src="<?=BASE_URL.'/'.DIR_INC;?>/images/GPIB_Immanuel_Bung_Karno_Mataram.png" alt="Logo" /></a>
			<a href="<?=BASE_URL;?>" class="retina-logo" data-dark-logo="<?=BASE_URL.'/'.DIR_INC;?>/images/GPIB_Immanuel_Bung_Karno_Mataram.png"><img src="<?=BASE_URL.'/'.DIR_INC;?>/images/GPIB_Immanuel_Bung_Karno_Mataram.png" alt="Logo" /></a>
		</div>
		<div class="top-advert">
			<img src="<?=BASE_URL;?>/<?=DIR_CON;?>/uploads/gpib_immanuel_bung_karno.jpg" alt="">
		</div>
	</div>
